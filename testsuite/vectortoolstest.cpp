...
int rotCVectorTest()
{
	...
	for (unsigned int iii = 2; iii < 4; iii++) //rotates theta
	{
...
/*	for (unsigned int iii = 2; iii < 4; iii++) //rotates phi, not working as expected due to sign issues and the like
	{
...
{	
	...
	unsigned int len { 3 }; // match to length of cnst or x|y|zval / 2
	...
	for (unsigned int iii = 0; iii < len; iii++)
	{
...
int vtTestMain()
{
	...
	for (unsigned int ii = 0; ii < tests; ii++)
	{
