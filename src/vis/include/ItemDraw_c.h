...
public:
	ParticlePic(int interval = 1, int retain = 0, double radius = 0.1, dblArray3_t color = { 0.0, 1.0, 0.0 }) :
...
public:
	WireCoilPic(dblArray3_t center, dblArray3_t axis, double radius, double thickness = 0.1) :
